...
echo "\n\n\nAdding secrets"
dfx canister call hackathon addSecret '("secret", "uploaderpubkey", 10, 1635724799, 86400, vec {"share1"; "share2"; "share3"}, vec {principal "'"${default_principal}"'"; principal "'"${default_principal}"'"; principal "'"${default_principal}"'"}, vec {1;1;1})'
