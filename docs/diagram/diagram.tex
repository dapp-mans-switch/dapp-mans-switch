...
\begin{tikzpicture}
  ...
  \node[draw, right=\spacing of ks3] (eks3) {$\E(\pk_{\includegraphics[width=6pt]{mage.png}}, \KS_3)$};
  \node[draw, right=\spacing of ks2] (eks2) {$\E(\pk_{\includegraphics[width=5pt]{supervillain.png}}, \KS_2)$};
  \node[draw, right=\spacing of ks1] (eks1) {$\E(\pk_{\includegraphics[width=6pt]{farmer.png}}, \KS_1)$};
  \node[      right=2cm of kss]      (ekss) {$\ldots$};
  \node[draw, right=\spacing of ksn] (eksn) {$\E(\pk_{\includegraphics[width=6pt]{astronaut.png}}, \KS_n)$};
  ...
  \node[right=1mm of eks2] (s2) {\includegraphics[width=9mm]{supervillain.png}};
  \node[right=1mm of eks3] (s3) {\includegraphics[width=1cm]{mage.png}};
  \node[right=1mm of eksn] (sn) {\includegraphics[width=1cm]{astronaut.png}};
  ...
  \node[draw, right=39mm of eks3] (dks3) {$\D(\sk_{\includegraphics[width=6pt]{mage.png}}, \KS_3)$};
  % the super villain won't decrypt :^)
  \node[      right=47mm of eks2] (dks2) {\includegraphics[width=5mm]{cross.png}};
  \node[draw, right=39mm of eks1] (dks1) {$\D(\sk_{\includegraphics[width=6pt]{farmer.png}}, \KS_1)$};
  \node[      right=56mm of ekss] (dkss) {$\ldots$};
  \node[draw, right=39mm of eksn] (dksn) {$\D(\sk_{\includegraphics[width=6pt]{astronaut.png}}, \KS_n)$};
  ...
  \node[draw, below=of sn] (esecret) {\E(Secret)};
  \draw[arrow, rounded corners=70pt] (sss.-75) |- (esecret);
