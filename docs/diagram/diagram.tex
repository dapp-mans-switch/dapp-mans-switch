...
\begin{tikzpicture}
  ...
  \node[draw, right=of sss]          (ks3) {$\KS_3$};
  ...
  \node[draw, right=of ks3]      (eks3) {$\E(\pk, \KS_3)$};
  \node[draw, right=of ks2]      (eks2) {$\E(\pk, \KS_2)$};
  \node[draw, right=of ks1]      (eks1) {$\E(\pk, \KS_1)$};
  \node[      right=19mm of kss] (ekss) {$\ldots$};
  \node[draw, right=of ksn]      (eksn) {$\E(\pk, \KS_n)$};
  ...
  \node[draw, rounded rectangle, right=15mm of dks3, text width=20mm, align=center]
